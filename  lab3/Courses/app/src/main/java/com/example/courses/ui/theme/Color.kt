...
val primary_dark = Color(0xFF6200EE)
val secondary_dark = Color(0xFFFFFFFF)
val tertiary_dark = Color(0xFFBB86FC)
...
val primary_light = Color(0xFF6200EE)
val secondary_light = Color(0xFFFFFFFF)
val tertiary_light = Color(0xFFBB86FC)